// miniprogram/pages/article/list/list.js
const app = getApp()
Page({
  ...
  getCategory() {
    app.jszp.getArticleCategory()
      .then(res => {
        this.setData({
          categoryList: res.article_category
        })
      })
  },
  ...
  getArticleList() {
    ...
    app.jszp.getArticleList(search_str)
      .then(res => {
        this.setData({
  ...
  bindPickerChange: function (e) {
    ...
    data.curOption[1] = data.categoryList[e.detail.value];
    data.curOption[3] = 1;
    this.setData(data);
    this.getArticleList();
  },
